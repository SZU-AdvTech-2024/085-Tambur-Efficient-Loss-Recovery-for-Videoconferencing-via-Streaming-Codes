...
void print_usage(const string & program_name)
{
  ...
  "--er <level>         0: skip error frames\n"
  "                     1: decode using error concealment\n"
...
int main(int argc, char * argv[])
{
  ...
  const option cmd_line_opts[] = {
    ...
    {"er",      required_argument, nullptr, 'E'},
  ...
  // initialize decoder
  H264Decoder decoder(width, height, lazy_level, er, output_path);
